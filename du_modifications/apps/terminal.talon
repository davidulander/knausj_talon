...
update cdk shared: 'cd cdk/shared; git stash; git checkout master; git pull; git stash apply; cd ../../ \n'
update shared: 'cd shared; git stash; git checkout master; git pull; git stash apply; cd ../../ \n'
