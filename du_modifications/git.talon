...
git rebase origin: "git rebase origin/main\n"
git rebase quick stash: "git stash; git fetch; git rebase origin/main; git stash apply\n"
git rebase quick: "git fetch; git rebase origin/main\n"
