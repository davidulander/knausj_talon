...
def setup_default_alphabet():
    ...
    initial_default_alphabet = "arm bat cap drum each fail gust hemp ice jury crunch look made near oi pee queue red sun trap urge vest whale plex yank zoe".split()
